import { Utils } from 'src/app/services/EscService/Utils';
import { Constants,FeedControlSequences,CharacterSpacing,CashDrawer,LineSpacing,Margins,Paper,TextFormat,Barcode1DOptions,BarcodeFormat,BarcodePDF417Options,BarcodeQROptions,BitmapFormat,GSV0Format,Code2DFormat,Color,Screen, HardwareOpt } from 'src/app/services/EscService/Commands';
import { Barcode1DType, BarcodeFont, BarcodeTextPosition, BitmapDensity, FeedControlSequence, FontFamily, FontStyle, Hardware, TextAlignment } from './Enum';
import { ESCPOSImage } from './Image';
import { cptable } from 'src/app/services/EscService/cptable';
...
export class Document {
    ...
    public rawChar(code:number):Document{
      let buf: number[][] = [];
      buf.push([code]);
      this._addB(buf);
      return this;
    ...
    public str2ab(str) {
      ...
      for (var i = 0, strLen = str.length; i < strLen; i++) {
        this._buffer = this._buffer.concat(str.charCodeAt(i));
      }
      return buf;
    }    
